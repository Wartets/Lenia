...
(function() {
    ...
    /**
     * Handle tab link button clicks (buttons within content)
     * @param {Event} event - Click event
     */
    ...
    function openMobileMenu() {
        ...
        elements.mobileMenuToggle.querySelector('.hamburger').style.backgroundColor = 'transparent';
    }
    ...
    function closeMobileMenu() {
        ...
        elements.mobileMenuToggle.querySelector('.hamburger').style.backgroundColor = '';
    }
    ...
    /**
     * Initialize the placeholder canvas with animated effect
     */
    function initCanvas() {
    ...
    /**
     * Render math in all tab contents
     */
    ...
    /**
     * Get KaTeX render configuration
     * @returns {Object} KaTeX configuration object
     */
    ...
    function initSmoothScroll() {
        document.querySelectorAll('a[href^="#"]').forEach(anchor => {
            if (!anchor.hasAttribute('data-tab') && !anchor.hasAttribute('data-tab-link')) {
    ...
    function initScrollAnimations() {
        ...
        document.querySelectorAll('.preview-card, .concept-card, .pipeline-step, .timeline-item').forEach(el => {
    ...
    /**
     * Initialize interactive variant cards
     */
    function initVariantCards() {
        const variantCards = document.querySelectorAll('.variant-detailed[onclick]');
    ...
    /**
     * Initialize taxon card image fallbacks
     */
    function initTaxonImages() {
        ...
        taxonImages.forEach(img => {
            ...
            img.addEventListener('error', function() {
                ...
                if (placeholder && placeholder.classList.contains('taxon-image-placeholder')) {
    ...
    /**
     * Initialize colormap preview hover effects
     */
